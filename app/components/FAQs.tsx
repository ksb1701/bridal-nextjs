...
export default function FAQs() {
  ...
  return (
    <section className="py-14">
      <div className="container mx-auto5">
        ...
        <div className="xl:w-[80%] mx-auto">
          {faqData.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="mb-3.75 overflow-hidden rounded-md bg-brand-blue px-3.5 py-5 xl:px-11 lg:py-10 text-white shadow-[0_3px_10px_rgba(0,0,0,0.1)] transition-all duration-300"
              >
                <div
